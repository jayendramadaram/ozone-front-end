      ...
      <div className="flex justify-center mb-32 sm:mt-20 md:mt-20">
        ...
        <div className="flex justify-between text-base text-white mb-16 sm:flex-wrap sm:mb-0 md:flex-wrap md:mb-0 px-4">
          <div className="sm:w-1/2 md:w-1/3 md:pl-20">
            ...
            <FooterLink href="https://github.com/Ozone-Labs">Whitepaper</FooterLink>
            <FooterLink href="https://Ozonelabs.medium.com/">Blog</FooterLink>
          </div>
          <div className="sm:w-1/2 sm:pl-12 md:w-1/3 md:pl-16">
            ...
            <FooterLink href="https://x.com/Ozone">X</FooterLink>
            <FooterLink href="https://t.me/Ozone_labs">Telegram</FooterLink>
          </div>
          ...
          <div className="sm:w-1/2 sm:mt-6 sm:pl-12 md:w-1/3 md:pl-20">
            ...
            <FooterLink href="https://github.com/Ozone-Labs">Github</FooterLink>
          ...
          <div className="sm:w-7/12 sm:-mt-24 md:w-1/3 md:pl-16">
            ...
            <FooterLink href="mailto:hello@Ozoneprotocol.xyz">Careers</FooterLink>
            <FooterLink href="mailto:hello@Ozoneprotocol.xyz">
              Contact Us
            </FooterLink>
          </div>
          ...
          <div className="sm:w-full sm:mt-6 md:w-full md:mt-20">
            ...
            <div className="flex justify-center items-center mb-7 sm:px-6 md:mb-4">
              <IconLink className="mr-4" IconComponent={DclIcon18} href="https://x.com/Ozone" />
              <IconLink className="mx-4" IconComponent={FooterIcon2} href="https://t.me/Ozone_labs" />
              <IconLink className="mx-4" IconComponent={FooterIcon3} href="https://discord.gg/fBNwhSTc" />
              <IconLink className="ml-4" IconComponent={FooterIcon4} href="https://Ozoneprotocol.medium.com" />
            </div>
