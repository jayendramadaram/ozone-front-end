...
const Dcl = () => {
  function learnMore() {
    window.open('https://Ozoneprotocol.medium.com/');
  }
      ...
      <div className="relative z-10 overflow-hidden mx-auto  lg:w-4/5 sm:w-full md:w-full lg:mt-20 xl:mt-20 2xl:mt-20 md:mt-20 sm:mt-72">
        ...
        <div className="relative z-10  flex-wrap gap-14 justify-between items-baseline text-white mb-24 grid grid-cols-3 sm:grid-cols-1 sm:pl-4 sm:pr-4 sm:mb-0 md:px-6 md:mb-24 md:gap-6">
          <FeatureCard
            ...
            description="Ozone relies on Cutting Threshold signature scheme Frost, Making asset control completely decentralized"
          />
          <FeatureCard
            Icon={DclIcon4}
            title="Darkpools"
            description="Ozone offers complete private execution of orders, preventing High value trades from being front-runned or vulnerable to value Extraction"
          />
          <FeatureCard
            Icon={DclIcon5}
            title="AI driven Interoperability"
            description="Natty AI, is Ozone's own AI engine with a primary goal of making cross chain Interations more user friendly"
          />
        </div>
