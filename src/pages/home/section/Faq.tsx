...
export default function Faq() {
  ...
  const faqData = [
    {
      question: "What is Ozone Bridge about?",
      answer: "Ozone is a decentralized aggregation layer that enables seamless cross-chain transactions with enhanced security and privacy.",
    },
    {
      question: "How does Ozone ensure security?",
      answer: "Ozone employs cutting-edge FROST signature scheme and powerful slashing mechanics, which ensure decentralized authority and punish malicious actors.",
    },
    {
      question: "What is the FROST Algorithm?",
      answer: "The FROST Algorithm is a cutting-edge technology used by Ozone to ensure decentralized authority and provide the fastest transaction speeds in the market.",
    },
    {
      question: "How does Ozone handle liquidity?",
      answer: 'Ozone relies on "LOCK AND MINT" and atomic swaps as its primary bridging techniques. Additionally, it incentivizes users to rebalance liquidity through lower fees.',
    },
    {
        ...
        <div className="w-3/5 md:w-4/5 sm:w-4/5">
          <div className="flex flex-col space-y-4">
            ...
            <div className="text-gray-300">
              Have a question that is not answered? You can contact us at hello@Ozone.io
            </div>
          </div>
        </div>
